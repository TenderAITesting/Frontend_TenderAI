      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <div style={{ flex: 1, overflowY: 'auto' }}>
          <div style={{ padding: '36px 56px', maxWidth: 800, margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 11, color: 'var(--nj-semantic-color-border-neutral-subtle-default)', borderTop: '1px solid var(--nj-semantic-color-border-neutral-minimal-default)', paddingTop: 14, marginTop: 48, fontFamily: "'Lato', sans-serif" }}>
